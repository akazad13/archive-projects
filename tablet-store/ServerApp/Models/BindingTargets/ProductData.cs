...
namespace ServerApp.Models.BindingTargets
{
    ...
    public class ProductData
    {
        ...
        public string Brand
        {
            get => Product.Brand; set => Product.Brand = value;
        }
        ...
        {
            get => Product.ProductImgUrl; set => Product.ProductImgUrl = value;
        }

        [Required]
        public string ProductFeatures
        {
            get => Product.ProductFeatures; set => Product.ProductFeatures = value;
        }
